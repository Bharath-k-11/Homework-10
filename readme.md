...
#Assignment 10 – Event Manager Company: User Management REST API
...
Currently, when requesting a JWT token (via login or other authentication methods), the API doesn't handle various edge cases properly. Users may experience unexpected behavior such as:
